...
{
	public class AddProjectTeamValidator : AbstractValidator<AddProjectTeamDto>
	{
		private readonly IProjectDal _projectDal;
		private readonly IUserContext _userContext;
		private Project? _cachedProject;

		public AddProjectTeamValidator(IProjectDal projectDal, IUserContext userContext)
		{
