...
{
	public class AddTaskCommentValidator : AbstractValidator<AddTaskCommentDto>
	{
		private readonly IBoardDal _boardDal;
		private readonly ITaskDal _taskDal;
		private readonly IUserContext _userContext;
		public AddTaskCommentValidator(IBoardDal boardDal, ITaskDal taskDal, IUserContext userContext)
		{
			_boardDal = boardDal;
			_taskDal = taskDal;
			_userContext = userContext;

			RuleFor(taskComment => taskComment.TaskId)
