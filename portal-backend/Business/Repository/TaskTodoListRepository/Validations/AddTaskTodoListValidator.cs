...
{
	public class AddTaskTodoListValidator : AbstractValidator<AddTaskTodoListDto>
	{
		private readonly IBoardDal _boardDal;
		private readonly ITaskDal _taskDal;
		private readonly IUserContext _userContext;
		public AddTaskTodoListValidator(IBoardDal boardDal, ITaskDal taskDal, IUserContext userContext)
		{
			_boardDal = boardDal;
			_taskDal = taskDal;
			_userContext = userContext;

			RuleFor(taskTodoList => taskTodoList.TaskId)
