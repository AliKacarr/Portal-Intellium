...
{
	public class DeleteTaskTodoListValidator : AbstractValidator<int>
	{
		...
		public DeleteTaskTodoListValidator(IBoardDal boardDal, IUserContext userContext, ITaskTodoListDal taskTodoListDal)
		{
			_boardDal = boardDal;
			_userContext = userContext;
			_taskTodoListDal = taskTodoListDal;

			RuleFor(taskTodoListId => taskTodoListId)
