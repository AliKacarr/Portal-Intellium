...
namespace DataAccess.Concrete.EntityFramework.Context.Migrations
{
    ...
    [Migration("20260430131219_FixFolderCreatedByAndNoteTaskId")]
    partial class FixFolderCreatedByAndNoteTaskId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Concrete.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CustomerId = 1L,
                            AddetAt = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6136),
                            ...
                            IsActive = true,
                            LicenceFinishDate = new DateTime(2026, 6, 29, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6111),
                            LicenceKey = "J9W954ijk",
                            LicenceStartDate = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6095),
            ...
            modelBuilder.Entity("Entities.Concrete.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddedAt = new DateTime(2026, 4, 30, 13, 12, 18, 498, DateTimeKind.Utc).AddTicks(6063),
                            Name = "admin"
                        },
                        new
                        {
                            Id = 2L,
                            AddedAt = new DateTime(2026, 4, 30, 13, 12, 18, 498, DateTimeKind.Utc).AddTicks(6065),
                            Name = "worker"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddetAt = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6490),
                            ConfirmValue = "6aada284-263e-4d1e-bb2e-e229e635b435",
                            Email = "turgut.ozcelikyurek@intellium.com.tr",
                            IsActive = true,
                            IsConfirm = true,
                            Language = "Türkçe",
                            MailConfirm = true,
                            MailConfirmDate = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6493),
                            Name = "Turgut Özçelikyürek",
                            PasswordHash = new byte[] { 4, 172, 60, 162, 183, 77, 188, 116, 138, 206, 36, 123, 51, 185, 50, 62, 37, 73, 187, 87, 60, 239, 233, 147, 60, 71, 84, 213, 73, 239, 124, 120, 120, 78, 21, 88, 127, 14, 12, 77, 215, 123, 111, 214, 194, 0, 152, 62, 125, 29, 196, 80, 148, 49, 112, 52, 132, 145, 48, 74, 47, 112, 189, 76 },
                            PasswordSalt = new byte[] { 157, 125, 211, 76, 125, 125, 106, 38, 252, 79, 179, 247, 203, 140, 189, 91, 42, 245, 74, 102, 22, 96, 201, 9, 21, 242, 201, 108, 72, 46, 203, 145, 42, 140, 16, 130, 172, 219, 126, 70, 151, 141, 243, 27, 242, 44, 217, 6, 82, 9, 181, 108, 153, 233, 184, 51, 236, 242, 150, 58, 46, 251, 73, 102, 230, 109, 129, 95, 53, 37, 59, 105, 74, 97, 240, 188, 26, 44, 219, 168, 112, 202, 233, 59, 230, 64, 218, 155, 41, 69, 60, 58, 191, 125, 180, 144, 6, 209, 167, 109, 86, 62, 91, 246, 248, 84, 184, 200, 166, 203, 63, 142, 168, 153, 213, 233, 252, 137, 85, 234, 73, 93, 204, 120, 239, 50, 165, 168 }
                        },
                        new
                        {
                            Id = 2L,
                            AddetAt = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6615),
                            ConfirmValue = "ae561ae0-f161-4312-9997-8ebfb5086783",
                            Email = "test.user@intellium.com.tr",
                            IsActive = true,
                            IsConfirm = true,
                            Language = "Türkçe",
                            MailConfirm = true,
                            MailConfirmDate = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6617),
                            Name = "Test Kullanıcı",
                            PasswordHash = new byte[] { 155, 243, 163, 207, 223, 29, 252, 100, 69, 182, 24, 45, 209, 197, 155, 4, 117, 104, 253, 146, 212, 30, 187, 143, 49, 106, 145, 42, 164, 171, 42, 253, 48, 218, 152, 141, 88, 18, 229, 171, 120, 118, 126, 82, 225, 4, 214, 222, 203, 222, 114, 232, 105, 191, 146, 151, 41, 155, 116, 149, 59, 205, 41, 93 },
                            PasswordSalt = new byte[] { 195, 17, 38, 36, 53, 149, 239, 86, 48, 213, 174, 91, 192, 212, 226, 18, 77, 113, 89, 99, 18, 41, 14, 168, 109, 141, 104, 41, 175, 173, 132, 74, 147, 19, 71, 195, 167, 197, 152, 193, 13, 230, 78, 130, 84, 129, 43, 85, 123, 103, 223, 12, 232, 34, 138, 2, 61, 137, 250, 69, 93, 201, 105, 39, 146, 24, 87, 137, 60, 212, 81, 53, 90, 229, 57, 147, 97, 227, 85, 227, 102, 69, 225, 252, 194, 57, 172, 90, 47, 231, 95, 143, 30, 50, 85, 152, 239, 56, 170, 148, 23, 60, 88, 126, 161, 253, 67, 100, 9, 228, 40, 231, 44, 224, 236, 157, 47, 14, 55, 201, 0, 199, 215, 108, 127, 155, 24, 153 }
                        });
                });
            ...
            modelBuilder.Entity("Entities.Concrete.UserCustomer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddetAt = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6801),
                            CustomerId = 1L,
                            IsActive = true,
                            UserId = 1L
                        },
                        ...
                        {
                            Id = 2L,
                            AddetAt = new DateTime(2026, 4, 30, 16, 12, 18, 498, DateTimeKind.Local).AddTicks(6815),
                            CustomerId = 1L,
                            IsActive = true,
                            UserId = 2L
                        });
            ...
            modelBuilder.Entity("Entities.Concrete.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddedAt = new DateTime(2026, 4, 30, 13, 12, 18, 498, DateTimeKind.Utc).AddTicks(5851),
                            Description = "admin",
                            RoleName = "admin"
                        },
                        new
                        {
                            Id = 2L,
                            AddedAt = new DateTime(2026, 4, 30, 13, 12, 18, 498, DateTimeKind.Utc).AddTicks(5856),
                            Description = "worker",
                            RoleName = "worker"
                        },
                        new
                        {
                            Id = 3L,
                            AddedAt = new DateTime(2026, 4, 30, 13, 12, 18, 498, DateTimeKind.Utc).AddTicks(5857),
                            Description = "user",
                            RoleName = "user"
                        });
                });
