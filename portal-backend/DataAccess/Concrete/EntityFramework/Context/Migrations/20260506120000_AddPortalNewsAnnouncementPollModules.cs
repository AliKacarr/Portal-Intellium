...
namespace DataAccess.Concrete.EntityFramework.Context.Migrations
{
    ...
    [Migration("20260506120000_AddPortalNewsAnnouncementPollModules")]
    public partial class AddPortalNewsAnnouncementPollModules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_NewsItems_NewsCategories_NewsCategoryId",
                        column: x => x.NewsCategoryId,
                        principalTable: "NewsCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_NewsItems_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Polls_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NewsComments_NewsItems_NewsId",
                        column: x => x.NewsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsItems_NewsCategoryId",
                table: "NewsItems",
                column: "NewsCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsItems_CreatedById",
                table: "NewsItems",
                column: "CreatedById");
