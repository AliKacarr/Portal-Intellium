...
namespace DataAccess.Concrete.EntityFramework.Context.Migrations
{
    ...
    [Migration("20260520134500_UseSingleUserLegalConsentAcceptedAt")]
    public partial class UseSingleUserLegalConsentAcceptedAt : Migration
    {
...
");
        ...
        {
            migrationBuilder.Sql(@"ALTER TABLE ""Users"" DROP COLUMN IF EXISTS ""LegalConsentAcceptedAt"";");
        }
    }
}
