...
export const REMOVE_SYNTHETIC_DRAFT_ROWS = "REMOVE_SYNTHETIC_DRAFT_ROWS";
...
export const PIN_EXPENSE_SUCCESS = "PIN_EXPENSE_SUCCESS";
export const BULK_ADD_EXPENSE_SUCCESS = "BULK_ADD_EXPENSE_SUCCESS";
