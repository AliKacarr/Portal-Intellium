    ...
    <LayoutWrapper>
      ...
      <Box>
        <Form>
          ...
          >
            <Input placeholder={intl.formatMessage({ id: 'forms.extra.unavailableChoice' })} id="error" />
          </FormItem>
          ...
          >
            <Input placeholder={intl.formatMessage({ id: 'forms.extra.warning' })} id="warning" />
          </FormItem>
          ...
          >
            <Input
              placeholder={intl.formatMessage({ id: 'forms.extra.contentBeingValidated' })}
              id="validating"
            />
          </FormItem>
          ...
          >
            <Input placeholder={intl.formatMessage({ id: 'forms.extra.content' })} id="success" />
          </FormItem>
          ...
          <FormItem
            ...
            validateStatus="warning"
          >
            <Input placeholder={intl.formatMessage({ id: 'forms.extra.warning' })} id="warning1" />
          </FormItem>
          ...
          >
            <Input placeholder={intl.formatMessage({ id: 'forms.extra.unavailableChoice' })} id="error1" />
          </FormItem>
        </Form>
      </Box>
      <PageHeader><IntlMessages id="forms.extra.formSubmitValidation" /></PageHeader>
      <Box>
        <FormValidation />
      </Box>
    </LayoutWrapper>
