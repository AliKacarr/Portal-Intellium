...
export default function() {
  ...
  return (
    <LayoutWrapper>
      <PageHeader><IntlMessages id="forms.extra.mention" /></PageHeader>

      <div className="isoBoxWrapper">
        <h3><IntlMessages id="forms.extra.customizeSuggestion" /></h3>
        <p><IntlMessages id="forms.extra.customizeSuggestionsDesc" /></p>
