    ...
    content: (
      <div className="isoExampleWrapper">
        <div style={{ padding: '10px 20px' }}>
          <FormFieldTitle className="isoFormFieldTitle"><IntlMessages id="forms.extra.input" /></FormFieldTitle>
...
export default function() {
  ...
  return (
    <LayoutWrapper>
      <PageHeader><IntlMessages id="forms.extra.stepperForm" /></PageHeader>
      <ContentHolder>
        ...
        <div className="steps-action">
          {current < steps.length - 1 && (
            <Button type="primary" onClick={next}>
              <IntlMessages id="forms.extra.next" />
            </Button>
          )}
          {current === steps.length - 1 && (
            <Button
            ...
            >
              <IntlMessages id="forms.extra.done" />
            </Button>
          )}
          {current > 0 && (
            <Button style={{ marginLeft: 8 }} onClick={prev}>
              <IntlMessages id="forms.extra.previous" />
            </Button>
          )}
        </div>
      </ContentHolder>
