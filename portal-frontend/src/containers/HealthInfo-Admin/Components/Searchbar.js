    ...
    <Space style={{ width: "100%" }} direction="vertical">
      <Space.Compact className="assets__searchbar-container" size="middle">
        <Input
          ...
          bordered
          placeholder={intl.formatMessage({ id: "healthInfoAdmin.search.searchPlaceholder" })}
          value={search}
        />
        <Button
        ...
        >
          {intl.formatMessage({ id: "healthInfoAdmin.search.filter" })}
        </Button>
        ...
        <Select
          ...
          placeholder={intl.formatMessage({ id: "healthInfoAdmin.search.categories" })}
        ...
        <Select
          ...
          placeholder={intl.formatMessage({ id: "healthInfoAdmin.search.status" })}
