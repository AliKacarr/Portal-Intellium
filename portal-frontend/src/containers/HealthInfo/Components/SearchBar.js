    ...
    <Space style={{ width: "100%" }} direction="vertical">
      <Space.Compact className="assets__searchbar-container" size="middle">
        <Input
          ...
          bordered
          placeholder={intl.formatMessage({ id: "healthInfo.search.searchPlaceholder" })}
          value={search}
        />
        <Button
        ...
        >
          {intl.formatMessage({ id: "healthInfo.search.filter" })}
        </Button>
        ...
        <Select
          ...
          placeholder={intl.formatMessage({ id: "healthInfo.search.categories" })}
        ...
        <Select
          ...
          placeholder={intl.formatMessage({ id: "healthInfo.search.status" })}
