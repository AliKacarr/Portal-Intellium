...
const groupColumns = [
  columns[0],
  {
    title: <IntlMessages id="tables.group.name" />,
    items: [columns[1], columns[2]],
  },
  {
    title: <IntlMessages id="tables.group.address" />,
    items: [columns[3], columns[4]],
  },
];
const tableinfos = [
  {
    title: <IntlMessages id="tables.tableinfos.simple" />,
    value: "simple",
    columns: clone(smallColumns),
  },
  {
    title: <IntlMessages id="tables.tableinfos.sortable" />,
    value: "sortView",
    columns: clone(sortColumns),
  },
  {
    title: <IntlMessages id="tables.tableinfos.search" />,
    value: "filterView",
    columns: clone(smallColumns),
  },
  {
    title: <IntlMessages id="tables.tableinfos.editable" />,
    value: "editView",
    columns: clone(editColumns),
  },
  {
    title: <IntlMessages id="tables.tableinfos.grouping" />,
    value: "groupView",
    columns: clone(groupColumns),
  },
  {
    title: <IntlMessages id="tables.tableinfos.customized" />,
